...
const SignIn = ({ 
  ...
  borderRadius = "10px",
  padding = "20px",
  headingText = "Login to NovaStream",
...
,
  ...
  const handleSubmit = (event) => {
    ...
    // Here you would typically integrate with an authentication service
    ...
    <div className="formqwdinn23d2" style={{ padding:"0px", display:"flex", flexDirection:"column", width:width, maxWidth:"calc(100vw - 40px)"}}>
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .submitbtni3dun23d{
          ...
          outline: none;
          background-color: ${signInColor1};
          font-weight: ${actionFontWeight};
          color: ${signInFontColor};
          cursor: pointer;
        }

        .submitbtni3dun23d:hover{
          background-color: ${signInColor2};
        }
        ...
        .gg-eye::after {
            top: 2px;
            box-shadow:
                inset 0 -8px 0 1.5px ${fontColor},
                inset 0 0 0 1.5px ${fontColor};
            width: 24px;
            opacity: 0.7;
            height: 24px
        }
      ...
      <div className="inputDivedj23nfcib23" style={{display:"flex", flexDirection:"column"}}>
        ...
        <div className="passwordivehd232d" style={{display:"flex", backgroundColor: inputBackgroundColor}}>
          <input className="input238ehd32d2f32"
      ...
      <button style={{fontSize: actionFontSize}} className="submitbtni3dun23d" type="submit">{signInButtonText}</button>
      </form>
